    ...
    <div class="row">
                    ...
                    <div class="card-body py-0">
                        <div class="media pb-1">
                            <div class="media-body white text-left">
                                <h3 class="font-large-1 white mb-0">{{$user}}</h3>
                                <span>Total User</span>
                            </div>
                            <div class="media-right white text-right">
                                <i class="fa fa-user-circle font-large-1"></i>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-12">
            <div class="card gradient-ibiza-sunset">
                <div class="card-content">
                    <a href="{{ route('admin.Brand.brandindex') }}">
                        <div class="card-body py-0">
                            <div class="media pb-1">
                                <div class="media-body white text-left">
                                    <h3 class="font-large-1 white mb-0">{{$brand}}</h3>
                ...
                <div class="card-content">
                    <a href="{{ route('admin.Seller.sellerindex') }}">
                        <div class="card-body py-0">
                            <div class="media pb-1">
                                <div class="media-body white text-left">
                                    <h3 class="font-large-1 white mb-0">{{$seller}}</h3>
                ...
                <div class="card-content">
                    <a href="{{ route('admin.store.index') }}">
                        <div class="card-body py-0">
                            <div class="media pb-1">
                                <div class="media-body white text-left">
                                    <h3 class="font-large-1 white mb-0">{{$store}}</h3>
                ...
                <div class="card-content">
                    <a href="{{ route('admin.Membership.membershipindex') }}">
                        <div class="card-body py-0">
                            <div class="media pb-1">
                                <div class="media-body white text-left">
                                    <h3 class="font-large-1 white mb-0">{{$membership}}</h3>
                                    <span>Total Membership Plan</span>
                                </div>
                                <div class="media-right white text-right">
                                    <i class="fa fa-id-card font-large-1"></i>
                                </div>
                            </div>
                        </div>
                        <div id="Widget-line-chart3" class="height-75 WidgetlineChart WidgetlineChartshadow mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <select class="select2-icons form-control" multiple>
                                            ...
                                            <optgroup label="File types">
                                                <option value="Pdf" data-icon="fa fa-file-pdf-o" selected>PDF</option>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table text-center m-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="height-50"
                                                    src="{{ asset('admin-assets/app-assets/img/elements/01.png') }}"
                                        ...
                                        <tr>
                                            <td><img class="height-50"
                                                    src="{{ asset('admin-assets/app-assets/img/elements/15.png') }}"
                                                    alt="Generic placeholder image" /></td>
                                            <td>iPhone</td>
                                            <td>2</td>
                                            <td>
                                                <span
                                                    class="badge badge-pill bg-light-danger cursor-pointer">Disabled</span>
                                            </td>
                                            <td>$99.00</td>
                                            <td>
                                                <i class="ft-trash-2"></i>
                                        ...
                                        <tr>
                                            <td><img class="height-50"
                                                    src="{{ asset('admin-assets/app-assets/img/elements/11.png') }}"
                                                    alt="Generic placeholder image" /></td>
                                            <td>iMac</td>
                                            <td>1</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img class="height-50"
                                                    src="{{ asset('admin-assets/app-assets/img/elements/14.png') }}"
                                                    alt="Generic placeholder image" /></td>
                                            <td>iWatch</td>
                                            <td>2</td>
                                            <td>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <span class="gradient-purple-bliss d-block rounded-circle mx-auto mb-2"
                                        style="width:10px; height:10px;"></span>
                        ...
                        <div class="card-body">
                            <div class="media pt-0 pb-2">
                                <img class="mr-3 avatar"
                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-12.png') }}"
                                    alt="Avatar" width="35">
                            ...
                            <div class="media py-2">
                                <img class="mr-3 avatar"
                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-3.png') }}"
                                    alt="Avatar" width="35">
                                <div class="media-body">
                            ...
                            <div class="media py-2">
                                <img class="mr-3 avatar"
                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-22.png') }}"
                                    alt="Avatar" width="35">
                                <div class="media-body">
                            ...
                            <div class="media py-2">
                                <img class="mr-3 avatar"
                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-18.png') }}"
                                    alt="Avatar" width="35">
                                <div class="media-body">
                            ...
                            <div class="media py-2">
                                <img class="mr-3 avatar"
                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-21.png') }}"
                                    alt="Avatar" width="35">
                                <div class="media-body">
...
@endsection
@push('script')
<script src="{{ asset('admin-assets/app-assets/js/dashboard1.min.js') }}"></script>
@endpush