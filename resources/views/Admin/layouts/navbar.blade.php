                ...
                <ul class="navbar-nav">
                    <!-- <li class="i18n-dropdown dropdown nav-item mr-2"><a
                            ...
                            id="dropdown-flag" href="javascript:;" data-toggle="dropdown"><img
                                ...
                                src="{{ asset('admin-assets/app-assets/img/flags/in.png') }}" alt="flag"><span
                                class="selected-language d-md-flex d-none">India</span></a>
                        <div class="dropdown-menu dropdown-menu-right text-left" aria-labelledby="dropdown-flag"><a
                                class="dropdown-item" href="javascript:;" data-language="en"><img
                                    class="langimg mr-2"
                                    src="{{ asset('admin-assets/app-assets/img/flags/in.png') }}"
                                    alt="flag"><span class="font-small-3">India</span></a><a
                                class="dropdown-item" href="javascript:;" data-language="es"><img
                                    class="langimg mr-2"
                                    src="{{ asset('admin-assets/app-assets/img/flags/es.png') }}"
                                    alt="flag"><span class="font-small-3">Spanish</span></a><a
                                class="dropdown-item" href="javascript:;" data-language="pt"><img
                                    class="langimg mr-2" src="{{ asset('admin-assets/app-assets/img/flags/pt.png') }}" alt="flag"><span
                                    class="font-small-3">Portuguese</span></a><a class="dropdown-item"
                                href="javascript:;" data-language="de"><img class="langimg mr-2"
                                    src="{{ asset('admin-assets/app-assets/img/flags/de.png') }}" alt="flag"><span
                                    class="font-small-3">German</span></a></div>
                    </li> -->
                    <!-- <li class="dropdown nav-item"><a class="nav-link dropdown-toggle dropdown-notification p-0 mt-2"
                        ...
                        <ul
                            ...
                            <li class="scrollable-container"><a class="d-flex justify-content-between"
                                    ...
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left">
                                            <div class="mr-3"><img class="avatar"
                                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-20.png') }}"
                                    ...
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left">
                                            <div class="mr-3"><img class="avatar"
                                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-11.png') }}"
                                                    alt="avatar" height="45" width="45"></div>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media d-flex align-items-center py-0 pr-0">
                                        <div class="media-left">
                                            <div class="mr-3"><img
                                                    src="{{ asset('admin-assets/app-assets/img/icons/sketch-mac-icon.png') }}"
                                                    alt="avatar" height="45" width="45"></div>
                                        </div>
                                        <div class="media-body">
                                            <h6 class="m-0">Update</h6><small
                                                class="noti-text">MyBook v2.0.7</small>
                                        </div>
                                    ...
                                    <div class="media d-flex align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 class="m-0"><span>Registration done</span><small
                                                    class="grey lighten-1 font-italic float-right">6 hrs ago</small>
                                            </h6>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <div class="d-flex justify-content-between cursor-pointer read-notification">
                                    ...
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left">
                                            <div class="mr-3"><img class="avatar"
                                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-6.png') }}"
                                                    alt="avatar" height="45" width="45"></div>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="d-flex justify-content-between cursor-pointer read-notification">
                                    ...
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left">
                                            <div class="mr-3"><img class="avatar"
                                                    src="{{ asset('admin-assets/app-assets/img/portrait/small/avatar-s-7.png') }}"
                                                    alt="avatar" height="45" width="45"></div>
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown nav-item mr-1"><a
                            ...
                            <div class="user d-md-flex d-none mr-2"><span class="text-right">{{Auth::guard('admin')->user()->name}}</span><span class="text-right text-muted font-small-3">{{Auth::guard('admin')->user()->roles[0]->name}}</span>
                            </div><img class="avatar" src="{{ asset('admin-assets/app-assets/img/portrait/small/admin.jpeg') }}"
