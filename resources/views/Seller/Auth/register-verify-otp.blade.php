    ...
    <div id="god-container">
        ...
        <div id="super-container2">
            ...
            <div class="title-container">
                <h1>Varify OTP</h1>
                <h4 style="color:darkgreen;"><b>Please Check Your Email !!</b></h4>
                <!-- <small class="text-muted"><i>Please Check Your Email</i></small> -->
            </div>

            <div class="form">
                <!-- Individual -->
                <form method="POST" action="{{ route('seller.verify_otp') }}" id="individual_form">
                    @csrf
                    <!-- <input type="text"> -->
                    <div class="form-group">
                        <div class="input-div">
                            <label for="otp"></label>
                            <input type="text" name="otp" class="form-control @error('otp') is-invalid @enderror" id="otp" value="{{ old('otp') }}" placeholder="Enter OTP">
